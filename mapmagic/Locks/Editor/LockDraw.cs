...
namespace MapMagic.Locks
{
	public static class LockDraw
	{
		...
		public static float DrawCircle (PolyLineMesh line, Vector3 center, float radius, Color color, Vector3[] corners, List<Terrain> terrains, List<Rect> terrainRects, Transform parent=null)
		/// It will return an average height BTW almost for free :)
		{
			...
			line.DrawLine(corners, color, lineThickness, zMode:PolyLineMesh.ZMode.Overlay, offset:0, parent:parent);
