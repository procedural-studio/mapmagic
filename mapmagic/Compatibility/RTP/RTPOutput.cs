...
using static MapMagic.Nodes.MatrixGenerators.CTSOutput200;
...
namespace MapMagic.Nodes.MatrixGenerators 
{
	...
	public class RTPOutput200 : BaseTexturesOutput<RTPOutput200.RTPLayer>
	{
		...
		public RTPLayer[] layers = new RTPLayer[0];
		public override IList<RTPLayer> Layers 
			{ get => layers; 
			set{
				layers = new RTPLayer[value.Count];
				for (int i=0; i<value.Count; i++) 
					layers[i] = (RTPLayer)(object)(value[i]);
			}}
