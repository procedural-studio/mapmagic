...
using static MapMagic.Nodes.MatrixGenerators.DirectMatricesOutput200;
using System;
...
namespace MapMagic.Nodes.MatrixGenerators 
{
	...
	public class MegaSplatOutput200 : BaseTexturesOutput<MegaSplatOutput200.MegaSplatLayer>
	{
		...
		public MegaSplatLayer[] layers = new MegaSplatLayer[0];
		public override IList<MegaSplatLayer> Layers 
			{ get => layers; 
			set{
				layers = new MegaSplatLayer[value.Count];
				for (int i=0; i<value.Count; i++) 
					layers[i] = (MegaSplatLayer)(object)(value[i]);
			}}
