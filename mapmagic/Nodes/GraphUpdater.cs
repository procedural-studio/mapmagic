...
//							classes[i] = Update150to200(classes[i]);
			...
			/*public string Update150to200 (string src)
			{
				...
				{
					if (src.Contains("<mode mode=MapMagic.Generator+InoutType value=0/>")) //mode == Type.Map
					{
						src = src.Replace("<MapMagic.Generator+Input>", "<MapMagic.Generator+Inlet`1[" + matrixClassName + "]>");
						src = src.Replace("</MapMagic.Generator+Input>", "</MapMagic.Generator+Inlet`1[" + matrixClassName + "]>");
					}

					if (src.Contains("<mode mode=MapMagic.Generator+InoutType value=1/>")) //mode == Type.Objects
					{
				...
				if (src.StartsWith("<MapMagic.CombineGenerator>") && src.Contains("<<inputs mode=MapMagic.Generator+Input[]"))
					src = src.Replace("<inputs mode=MapMagic.Generator+Input[]", "<inputs mode=MapMagic.Generator+Inlet`1[" + objectClassName + "][]");
				if (src.StartsWith("<MapMagic.Generator+Input[]"))
				{
					while (src.Contains("mode=MapMagic.Generator+Input"))
						src = src.Replace("mode=MapMagic.Generator+Input", "mode=MapMagic.Generator+Inlet`1[" + objectClassName + "]");
					src = src.Replace("MapMagic.Generator+Input[]", "MapMagic.Generator+Inlet`1[" + objectClassName + "][]");
				}
				...
				{
					while (src.StartsWith("<MapMagic." + allPossibleObjectInlets[i]) && src.Contains("<" + allPossibleObjectInlets[i+1] + " mode=MapMagic.Generator+Input"))  //object output "input" value
						src = src.Replace("<" + allPossibleObjectInlets[i+1] + " mode=MapMagic.Generator+Input", "<" + allPossibleObjectInlets[i+1] + " mode=MapMagic.Generator+Inlet`1[" + objectClassName + "]");
				}
					
				for (int i=0; i<allPossibleObjectOutlets.Length; i++)
				{
					while (src.StartsWith("<MapMagic." + allPossibleObjectOutlets[i]) && src.Contains("<" + allPossibleObjectOutlets[i+1] + " mode=MapMagic.Generator+Output"))  //object output "input" value
						src = src.Replace("<" + allPossibleObjectOutlets[i+1] + " mode=MapMagic.Generator+Output", "<" + allPossibleObjectOutlets[i+1] + " mode=MapMagic.Generator+Outlet`1[" + objectClassName + "]");
				}

				//portals
				if (src.StartsWith("<MapMagic.Portal>"))
				{
					//src.Replace("<input mode=MapMagic.Generator+Input", "<input mode=MapMagic.Generator+Inlet");
					//src.Replace("<output mode=MapMagic.Generator+Output", "<output mode=MapMagic.Generator+Outlet");


					if (src.Contains("<mode mode=MapMagic.Generator+InoutType value=0/>")) //map mode
					{
						if (src.Contains("<form mode=MapMagic.Portal+PortalForm value=0/>"))
						{
							src = src.Replace ("<MapMagic.Portal>", "<MapMagic.InletPortal`1[" + matrixClassName + "]>");
							src = src.Replace ("</MapMagic.Portal>", "</MapMagic.InletPortal`1[" + matrixClassName + "]>");
						}
						if (src.Contains("<form mode=MapMagic.Portal+PortalForm value=1/>"))
						{
							src = src.Replace ("<MapMagic.Portal>", "<MapMagic.OutletPortal`1[" + matrixClassName + "]>");
							src = src.Replace ("</MapMagic.Portal>", "</MapMagic.OutletPortal`1[" + matrixClassName + "]>");
						}
						src = src.Replace ("<input mode=MapMagic.Generator+Input", "<input mode=MapMagic.Generator+Inlet`1[" + matrixClassName + "]");
						src = src.Replace ("<output mode=MapMagic.Generator+Output", "<output mode=MapMagic.Generator+Outlet`1[" + matrixClassName + "]");
					}
					if (src.Contains("<mode mode=MapMagic.Generator+InoutType value=1/>")) //object mode
					{
						if (src.Contains("<form mode=MapMagic.Portal+PortalForm value=0/>"))
						{
						...
						src = src.Replace ("<input mode=MapMagic.Generator+Input", "<input mode=MapMagic.Generator+Inlet`1[" + objectClassName + "]");
						src = src.Replace ("<output mode=MapMagic.Generator+Output", "<output mode=MapMagic.Generator+Outlet`1[" + objectClassName + "]");
					}
				}
				...
				while (src.Contains("mode=MapMagic.Generator+Input"))
				{
					src = src.Replace("mode=MapMagic.Generator+Input", "mode=MapMagic.Generator+Inlet`1[" + matrixClassName + "]");
				}

				while (src.Contains("mode=MapMagic.Generator+Output"))
				{
					src = src.Replace("mode=MapMagic.Generator+Output", "mode=MapMagic.Generator+Outlet`1[" + matrixClassName + "]");
				}

				//replacing matrix link in objects input
				if (src.StartsWith("<MapMagic.Generator+Inlet`1[" + objectClassName + "]>"))
					src.Replace("<link mode=MapMagic.Generator+Outlet`1[" + matrixClassName + "]", "<link mode=MapMagic.Generator+Outlet`1[" + objectClassName + "]");
