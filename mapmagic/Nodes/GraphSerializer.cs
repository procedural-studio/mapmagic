...
namespace MapMagic.Nodes
{
	...
	public class GraphSerializer200Beta : IGraphSerializer
	{
		...
		private static void AfterSerialize (object obj, Serializer.Object serObj)
		{
			...
			//{
			//	serObj.mode = placeholder.origType;
			//}
...
//if (serObj.mode!=null && serObj.mode.Contains("MapMagic.Expose.Override")) //temporary
//	serObj.mode = null;

			if (serObj.type == null)  //for some reason mode null after trying to reset expose
				return;	
		...
		private static readonly Dictionary<string,string> classRenames = new Dictionary<string, string>() {
			...
			{"MapMagic.Nodes.Inlet`1[Den.Tools.Matrices.MatrixWorld]","MapMagic.Nodes.MatrixInlet"},
			{"MapMagic.Nodes.Inlet`1[[Den.Tools.Matrices.MatrixWorld, Den.Tools, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]", "MapMagic.Nodes.MatrixInlet"},
			{"MapMagic.Nodes.Inlet`1[[Den.Tools.TransitionsList, Den.Tools, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]", "MapMagic.Nodes.TransitionsInlet"},
			{"MapMagic.Nodes.Inlet`1[[Den.Tools.Splines.SplineSys, Den.Tools, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]", "MapMagic.Nodes.SplinesInlet"},
			{"MapMagic.Nodes.Inlet`1[[Den.Tools.Segs.SplineSys, Den.Tools, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]", "MapMagic.Nodes.SegsInlet"},

			{"MapMagic.Nodes.Outlet`1[[Den.Tools.Matrices.MatrixWorld, Den.Tools, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]", "MapMagic.Nodes.MatrixOutlet"},
			{"MapMagic.Nodes.Outlet`1[[Den.Tools.TransitionsList, Den.Tools, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]", "MapMagic.Nodes.TransitionsOutlet"},
			{"MapMagic.Nodes.Outlet`1[[Den.Tools.Splines.SplineSys, Den.Tools, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]", "MapMagic.Nodes.SplinesOutlet"},
			{"MapMagic.Nodes.Outlet`1[[Den.Tools.Segs.SplineSys, Den.Tools, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]", "MapMagic.Nodes.SegsOutlet"},
			
			{"Den.Tools.Matrices.MatrixWorld, Den.Tools", "Den.Tools.Matrices.MatrixWorld, Den.Tools.Unity"}, //first rename inlets (they contain Den.Tools
			{", Den.Tools, Version=", ", Den.Tools.Native, Version="}
			};
	}
}