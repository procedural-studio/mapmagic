...
namespace MapMagic.Terrains
{
	...
	public class TerrainSettings 
	{
		...
		#if UNITY_2021_3 || UNITY_2022_3 || UNITY_2023_3_OR_NEWER
		[Val(name="Rendering Layer Mask", cat="Terrain")]	public int renderingLayerMask;
		#endif
		...
		//copy
		[Val(name="Copy", cat="Copy")]	public bool guiCopy = false;
		[Val(name="Copy Layers", cat="Copy")]	public bool copyLayers = true;
		[Val(name="Copy Tags", cat="Copy")]	public bool copyTags = true;
		[Val(name="Copy Static Flags", cat="Copy")]	public bool copyStatic = true;
		...
		public void ApplySettings (Terrain terrain)
		{
			...
			#if UNITY_2021_3 || UNITY_2022_3 || UNITY_2023_3_OR_NEWER
			terrain.renderingLayerMask = (uint)renderingLayerMask;
			#endif
		...
		/// Copies assigned layers, tags and components from MapMagic object to terrain
		{
			...
			{
				try { go.tag = mmGo.tag; } 
				catch { Debug.LogError("MapMagic: could not copy object tag"); }
			}
			...
			if (copyStatic)
				GameObjectUtility.SetStaticEditorFlags(go, GameObjectUtility.GetStaticEditorFlags(mmGo));
