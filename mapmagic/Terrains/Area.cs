			...
			public class Area
			{
				...
				public class Dimensions
				{
					...
					{ 
						...
						Vector3 pixelSize = 1f * worldSize.Vector3() / resolution;
				...
				{
					active = new Dimensions(
						rect: WorldToPixels(activeWorldPos.Vector3(), activeWorldSize.Vector3(), activeResolution),
						worldPos: activeWorldPos,
						worldSize: activeWorldSize);
				...
				{
					Vector2D terrainPos = terrain.transform.position.Vector2D();
					Vector2D terrainSize = terrain.terrainData.size.Vector2D();

					active = new Dimensions(
						rect: WorldToPixels(terrainPos.Vector3(), terrainSize.Vector3(), terrain.terrainData.heightmapResolution-1),
						worldPos: terrainPos,
				...
				public static Area FromFull (Vector2D fullWorldPos, Vector2D fullWorldSize, int fullResolution, int margins)
				{
					...
					area.full = new Dimensions(
						rect: WorldToPixels(fullWorldPos.Vector3(), fullWorldSize.Vector3(), fullResolution),
				...
				{
					active = new Dimensions(
						rect: WorldToPixels(activeWorldPos.Vector3(), active.worldSize.Vector3(), active.rect.size.x),
						worldPos: activeWorldPos,
