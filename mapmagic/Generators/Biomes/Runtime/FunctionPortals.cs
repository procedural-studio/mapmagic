...
namespace MapMagic.Nodes
{
	...
	//[GeneratorMenu (menu = "Functions/Enter", menuName = "Line", name = "Enter", iconName = "GeneratorIcons/FunctionIn", lookLikePortal=true)] public class SplineFnEnter : FnEnter<Den.Tools.Lines.LineSys> { }
	//[GeneratorMenu (menu = "Functions/Exit",  menuName = "Line", name = "Exit", iconName = "GeneratorIcons/FunctionOut", lookLikePortal=true)] public class SplineFnExit : FnExit<Den.Tools.Lines.LineSys> { }
