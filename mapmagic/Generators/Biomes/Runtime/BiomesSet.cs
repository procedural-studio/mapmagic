...
{
	public class BiomeLayer : Layer, IBiome, IInlet<MatrixWorld>, IOutlet<MatrixWorld>
	{
	...
	public class BiomesSet200 : Generator, IMultiInlet, IMultiLayer, ICustomComplexity, ICustomClear, IPrepare
	{
		...
		public IList<IUnit> UnitLayers //TODO: plug while using layered generators
			{get{
				...
				Layers = new BiomeLayer[value.Count];
				for (int i=0; i<value.Count; i++) 
					Layers[i] = (BiomeLayer)(object)(value[i]);
			}}
		...
		public override void Generate (TileData data, StopToken stop) 
		{
			...
			for (int i=0; i<layersCopy.Length; i++)
			{
				...
				layer.graph.Generate(subData, stop:stop);
			}
