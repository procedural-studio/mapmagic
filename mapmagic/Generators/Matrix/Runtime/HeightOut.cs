...
//			if (!enabled) { data.finalize.Remove(finalizeAction, this); return; }
		...
		public static void Finalize (TileData data, StopToken stop)
		{
			...
			if (data.heights == null || 
				...
				data.heights.worldPos != data.area.full.worldPos.Vector3D() || 
				data.heights.worldSize != data.area.full.worldSize.Vector3D()) 
		...
		public interface IApplyHeightData : IApplyData { } //common mode for all height applies
