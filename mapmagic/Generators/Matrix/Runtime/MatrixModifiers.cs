...
namespace MapMagic.Nodes.MatrixGenerators
{
	...
	*/
	...
	{
		public override (string, int) GetCodeFileLine () => GetCodeFileLineBase();  //to get here with right-click on generator
		[Val("Inlet", "Inlet")] public MatrixInlet srcIn = new MatrixInlet();
	...
	{
		public override (string, int) GetCodeFileLine () => GetCodeFileLineBase();  //to get here with right-click on generator
		[Val("Input A", "Inlet")]	public MatrixInlet aIn = new MatrixInlet();
		[Val("Input B", "Inlet")]	public MatrixInlet bIn = new MatrixInlet();
		[Val("Mask", "Inlet")]	public MatrixInlet maskIn = new MatrixInlet();
	...
	public class Blend200 : Generator, IMultiInlet, IOutlet<MatrixWorld>
	{
		...
		[Serializable]
		public class Layer : Nodes.Layer, IInlet<MatrixWorld>
		{
		...
		public override void Generate (TileData data, StopToken stop) 
		{
				...
				for (int i = 0; i < layers.Length; i++)
			{
				...
				MatrixWorld blendMatrix = data.ReadInletProduct(layer);
	...
	public class Normalize200 : Generator, IMultiInlet, IMultiOutlet
	{
		...
		public class NormalizeLayer : Layer, IInlet<MatrixWorld>, IOutlet<MatrixWorld>
		{
	...
	{
		public override (string, int) GetCodeFileLine () => GetCodeFileLineBase();  //to get here with right-click on generator
		[Val("From", min=0)]	public float from = 30;
		...
		public static MatrixWorld Slope (Matrix heights, Vector3D worldPos, Vector3D worldSize, float height, float from, float to, float range)
		{
			//delta map
	...
	public class Direction210 : Generator, IInlet<MatrixWorld>, IOutlet<MatrixWorld>
	{
		...
		public override void Generate (TileData data, StopToken stop)
		{
			...
			Vector3D dir = new Vector3D(Mathf.Sin(horAngle*Mathf.Deg2Rad), Mathf.Tan(vertAngle*Mathf.Deg2Rad), Mathf.Cos(horAngle*Mathf.Deg2Rad));
			dir = dir.normalized;
	...
	public class Ledge210 : Generator, IInlet<MatrixWorld>, IOutlet<MatrixWorld>, IMultiInlet
	{
		...
		[Val("Mask", "Inlet")] public MatrixInlet heightMaskIn = new MatrixInlet();
...
//		#endif
	...
	public class Beach210 : Generator, IInlet<MatrixWorld>, IMultiInlet, IOutlet<MatrixWorld>, IMultiOutlet
	{
		...
		[Val("Mask", "Inlet")] public MatrixInlet beachMaskIn = new MatrixInlet();
		[Val("Sand", "Outlet")] public MatrixOutlet sandMaskOut = new MatrixOutlet();
...
//		#endif
	...
	[System.Serializable]
	[GeneratorMenu (menu="Map/Modifiers", name ="ThisIsTheTestNameToFindOutHowItsShortened", iconName="GeneratorIcons/Erosion", disengageable = true, 
	...
	public class Sediment210 : Generator, IMultiInlet, IMultiOutlet
	{
		...
		[Val("Original", "Outlet")] public MatrixInlet origIn = new MatrixInlet();
		[Val("Eroded", "Outlet")] public MatrixInlet erodedIn = new MatrixInlet();
		public IEnumerable<IInlet<object>> Inlets()  { yield return origIn; yield return erodedIn; }

		[Val("Cliff", "Outlet")] public MatrixOutlet cliffOut = new MatrixOutlet();
		[Val("Sediment", "Outlet")] public MatrixOutlet sedimentOut = new MatrixOutlet();
	...
	public class Parallax210 : Generator, IInlet<MatrixWorld>, IMultiInlet, IOutlet<MatrixWorld>
	{
		...
		[Val("Intensity X", "Inlet")]	public MatrixInlet intensityInX = new MatrixInlet();
		[Val("Intensity Z", "Inlet")]	public MatrixInlet intensityInZ = new MatrixInlet();
