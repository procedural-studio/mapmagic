...
namespace MapMagic.Nodes.MatrixSetsGenerators
{
	...
	{
		public override (string, int) GetCodeFileLine () => GetCodeFileLineBase();  //to get here with right-click on generator
		[Val("Inlet", "Inlet")] public readonly IInlet<MatrixSet> srcIn = new MatrixSetInlet();
		[Val("Mask", "Inlet")]	public readonly IInlet<MatrixWorld> maskIn = new MatrixInlet();
	...
	{
		public override (string, int) GetCodeFileLine () => GetCodeFileLineBase();  //to get here with right-click on generator
		[Val("Input A", "Inlet")]	public MatrixSetInlet aIn = new MatrixSetInlet();
		[Val("Input B", "Inlet")]	public MatrixSetInlet bIn = new MatrixSetInlet();
	...
	public class Blend200 : Generator, IMultiInlet, IOutlet<MatrixWorld>
	{
		public class Layer
		{
			public MatrixInlet inlet = new MatrixInlet();
	...
	public class Parallax210 : Generator, IInlet<MatrixSet>, IMultiInlet, IOutlet<MatrixSet>
	{
		...
		{ 
			...
			if (stop!=null && stop.stop) return;
			Vector2D pixelOffset = offset / data.area.full.PixelSize.Vector2D();
